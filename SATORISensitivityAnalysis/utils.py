...
def get_correlation_stats(fmaps, att_maps, thresh, filter_matches, expecteds, corr_thresh, negate=False, limit=100000):
    position_interactions = get_position_interactions(att_maps, thresh, limit)
